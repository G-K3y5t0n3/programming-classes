...
# print(f'This is a string with f-string formatting... {a + 5 * 23 - 12:.2f} {b:a^20} {"nice":&>10}')
# # old
# print('This is a string with .format formatting... {:.2f} {} {:&>10}'.format((a + 5 * 23 - 12), b, "nice"))
# print('This is a string with .format formatting... {0:.2f} {1} {2:&>10}'.format((a + 5 * 23 - 12), b, "nice"))
# print()
